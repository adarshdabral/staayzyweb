...
function Home() {
    ...
    //   },
    // });
    const { data: featuredProperties } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useQuery"])({
        queryKey: [
            "featured-properties"
        ],
        queryFn: async ()=>{
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("/properties?status=approved");
            return response.data.slice(0, 6);
        },
        enabled: ("TURBOPACK compile-time value", "undefined") !== "undefined"
    });
    const handleSearch = ()=>{
        if (searchQuery.trim()) {
...
//# sourceMappingURL=_2b664ba5._.js.map